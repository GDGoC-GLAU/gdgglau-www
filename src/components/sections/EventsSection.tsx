...
const events = [
  ...
  {
    title: "Hackcentrix",
    desc: "An open theme hackathon that encourages creativity and innovation across all tech domains.",
    img: "/Static/Logo/hackcentrix.jpg",
    category: "Hackathon",
  },
  {
    title: "Web3 Vision",
    desc: "A session exploring the transformative potential of Web3 technologies.",
    img: "/Static/Logo/web3vision.webp",
    category: "Session",
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="fade-in slide-in-from-bottom-4 mb-12 animate-in text-center duration-700">
          ...
          <div className="mb-4 inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-primary/5 px-3 py-1 font-medium text-primary text-xs tracking-tight">
            {" "}
            <Calendar className="h-3 w-3" /> Past Events{" "}
          </div>{" "}
          ...
          {events.map((event, index) => (
            ...
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden">
                ...
                <Badge
                  className={`absolute top-2 left-2 border text-[10px] ${
