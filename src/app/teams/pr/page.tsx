import { ArrowLeft, Linkedin, Megaphone } from "lucide-react";
...
const teamMembers = [
	{
		name: "Anshika",
		role: "PR Team",
		img: "/Static/ProfilePictures/PRTeam/Anshika Pr Team.jpg",
		linkedin: "",
	},
	{
		name: "Prakhar Bajpai",
				...
				<div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
					...
					<div className="fade-in slide-in-from-bottom-4 mb-12 animate-in text-center duration-700">
						...
						<p className="mx-auto max-w-2xl text-muted-foreground text-sm">
							Connecting our community with the world. We craft compelling
							stories, manage outreach, and build meaningful relationships.
						</p>
					</div>
