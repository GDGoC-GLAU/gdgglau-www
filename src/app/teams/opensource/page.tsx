import { ArrowLeft, Code2, Linkedin } from "lucide-react";
...
const teamMembers = [
	{
		name: "Ishant Pathak",
		role: "Open Source",
		img: "/Static/ProfilePictures/OpenSourceTeam/ishant open saurce.png",
		linkedin: "",
	},
	{
		name: "Divyansh Varshney",
		role: "Open Source",
		img: "/Static/ProfilePictures/OpenSourceTeam/Divyansh Varshney Open Source Team .png",
		linkedin: "",
	},
	{
		name: "Shivanshu Sharma",
		role: "Open Source",
		img: "/Static/ProfilePictures/OpenSourceTeam/Shivanshu sharma Open Source.jpg",
		linkedin: "",
	},
	{
		name: "Arpita Patra",
		role: "Open Source",
		img: "/Static/ProfilePictures/OpenSourceTeam/Arpita patra open saurce .jpg",
		linkedin: "",
	},
	{
		name: "Akshit",
		role: "Open Source",
		img: "/Static/ProfilePictures/OpenSourceTeam/Akshit Open Source Team.jpg",
		linkedin: "",
	},
	{
		name: "Pushkar Singhal",
		role: "Open Source",
		img: "/Static/ProfilePictures/OpenSourceTeam/Pushkar Open Source.jpg",
		linkedin: "",
	},
];
...
export default function OpenSourceTeamPage() {
	return (
		<>
			<Navbar />
				...
				<div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
					...
					<div className="fade-in slide-in-from-bottom-4 mb-12 animate-in text-center duration-700">
						...
						<p className="mx-auto max-w-2xl text-muted-foreground text-sm">
							Building the future of open source, one contribution at a time. We
							believe in collaborative development and community-driven
							innovation.
						</p>
					</div>
