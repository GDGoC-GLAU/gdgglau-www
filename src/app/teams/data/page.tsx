import { ArrowLeft, Database, Linkedin } from "lucide-react";
...
const teamMembers = [
	{
		name: "Siddhika",
		role: "Data Team",
		img: "/Static/ProfilePictures/DataTeam/siddhika data team.jpg",
		linkedin: "",
	},
	{
		name: "Unnati Agarwal",
		role: "Data Team",
		img: "/Static/ProfilePictures/DataTeam/Unnati Data team.jpg",
		linkedin: "",
	},
	{
		name: "Nandini Raj Shrivastav",
		role: "Data Team",
		img: "/Static/ProfilePictures/DataTeam/Nandini Raj shrivastav.jpg",
		linkedin: "",
	},
	{
		name: "Harshit Dixit",
		role: "Data Team",
		img: "/Static/ProfilePictures/DataTeam/Harshit Dixit Data Team.jpg",
		linkedin: "",
	},
];
				...
				<div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
					...
					<div className="fade-in slide-in-from-bottom-4 mb-12 animate-in text-center duration-700">
						...
						<p className="mx-auto max-w-2xl text-muted-foreground text-sm">
							Transforming data into insights. We analyze, visualize, and
