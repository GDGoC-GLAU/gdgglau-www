import { ArrowLeft, Brain, Linkedin } from "lucide-react";
...
const teamMembers = [
	{
		...
		img: "/Static/ProfilePictures/MLTeam/Updesh ML team.jpg",
		linkedin: "",
	},
	{
		name: "Aayush Gaur",
		role: "Machine Learning",
		img: "/Static/ProfilePictures/MLTeam/Ayush_Gaur ML Team.png",
		linkedin: "",
	},
	{
		name: "Aakash Pratap Singh",
		role: "Machine Learning",
		img: "/Static/ProfilePictures/MLTeam/Aakash Pratap Singh.jpg",
		linkedin: "",
	},
];
				...
				<div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
					...
					<div className="fade-in slide-in-from-bottom-4 mb-12 animate-in text-center duration-700">
						...
						<p className="mx-auto max-w-2xl text-muted-foreground text-sm">
							Pushing the boundaries of AI and machine learning. We explore
							neural networks, deep learning, and cutting-edge algorithms.
						</p>
					</div>
